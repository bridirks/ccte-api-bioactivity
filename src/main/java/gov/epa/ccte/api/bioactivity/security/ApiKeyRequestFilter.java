package gov.epa.ccte.api.bioactivity.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import gov.epa.ccte.api.bioactivity.domain.ApiKey;
import gov.epa.ccte.api.bioactivity.repository.ApiKeyRepository;
import gov.epa.ccte.api.bioactivity.web.rest.error.AuthorizationProblem;
...
//        }
        ...
        if(key == null || key.equals("")){
            ...
            log.warn("*** API key {} not recognized *** ", key);
        }
    }
